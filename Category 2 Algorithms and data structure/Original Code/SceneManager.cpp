...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("../../Utilities/textures/stainless.jpg", "cup");
	bReturn = CreateGLTexture("../../Utilities/textures/rusticwood.jpg", "top");
	bReturn = CreateGLTexture("../../Utilities/textures/knife_handle.jpg", "board");
	bReturn = CreateGLTexture("../../Utilities/textures/cheddar.jpg", "cheese"); 
...
void SceneManager::DefineObjectMaterials()
{
	...
	cementMaterial.ambientColor = glm::vec3(0.4f, 0.3f, 0.1f);
	cementMaterial.ambientStrength = 0.2f;
	cementMaterial.diffuseColor = glm::vec3(0.3f, 0.2f, 0.1f);
	cementMaterial.specularColor = glm::vec3(0.1f, 0.1f, 0.1f);
	cementMaterial.shininess = 0.3;
	cementMaterial.tag = "wood";

	m_objectMaterials.push_back(woodMaterial);

	OBJECT_MATERIAL tileMaterial;
	cementMaterial.ambientColor = glm::vec3(0.2f, 0.3f, 0.4f);
	cementMaterial.ambientStrength = 0.3f;
	cementMaterial.diffuseColor = glm::vec3(0.3f, 0.2f, 0.1f);
	cementMaterial.specularColor = glm::vec3(0.4f, 0.5f, 0.6f);
	cementMaterial.shininess = 25.0;
	cementMaterial.tag = "tile";
	...
	cementMaterial.ambientStrength = 0.3f;
	cementMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	cementMaterial.specularColor = glm::vec3(0.6f, 0.6f, 0.6f);
	cementMaterial.shininess = 85.0;
	cementMaterial.tag = "glass";

	m_objectMaterials.push_back(glassMaterial);

	OBJECT_MATERIAL clayMaterial;
	cementMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.3f);
	cementMaterial.ambientStrength = 0.3f;
	cementMaterial.diffuseColor = glm::vec3(0.4f, 0.4f, 0.5f);
	cementMaterial.specularColor = glm::vec3(0.2f, 0.2f, 0.2f);
	cementMaterial.shininess = 0.5;
	cementMaterial.tag = "clay";
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.25f, 1.25f, 7.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.0f, 6.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.0f, 6.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.0f, 1.0f, 6.0f);
